<?
	/*
	 * TinyModelDiffHelpersTest.php
	 *
	 * Tests for:
	 *    - type_from_mysql_type_string()
	 *    - char_length_from_mysql_type_string()
	 *    - get_table_descriptions_for_DB()
	 *    - get_SQL_description()
	 *
	 */
	...
	class TinyModelDiffHelpersTest extends TM_Generic_TestCase {
		...
		public function testHelper_typefns() {
			$test_sql_str = 'varchar(207) not null';

			$coltype = Helpers::type_from_mysql_type_string($test_sql_str);
			$this->wrapAssert(assertEquals, [$coltype, 'varchar'], 'Diff/Helpers: type_from_mysql_type_string()');

			$collength = Helpers::char_length_from_mysql_type_string($test_sql_str);
			$this->wrapAssert(assertEquals, [$collength, 207], 'Diff/Helpers: char_length_from_mysql_type_string()');
	   }
		...
		public function testHelper_tblDescr() {
			...
			$this->wrapAssert(assertEquals,
			                  [
			                     ...
			                     [ 'type' => 'int', 'notnull' => true, 'unsigned' => false ]
			                  ],
			...
			$this->wrapAssert(assertEquals,
			                  [
			                     ...
			                     [ 'type' => 'varchar', 'notnull' => false, 'length' => 100 ]
			                  ],
